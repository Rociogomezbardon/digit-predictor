...
if __name__ == "__main__":
    #img_name = 'sudoku_images/1111.jpg'    #+input('image name\n')
    ...
    thresh2 = cv.threshold(gaus, 0,255, cv.THRESH_BINARY_INV + cv.THRESH_OTSU)[1]
